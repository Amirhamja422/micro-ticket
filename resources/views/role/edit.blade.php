    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-widgets.input-component inputColClass="col-xl-12 col-md-12" inputLabel="Role Name" inputId="name"
                    inputType="text" required='required' :inputVal="$role->name" />

                <h6>All Permissions<span class="text-danger error_txt checkPermission"
                        style="margin-top: 5px!important;"></span></h6>
                                    ...
                                    <td class="fifty_percent">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input checkAllPermissionByGroup_{{$result['group_id']}}"
                                                onclick="checkGroupByPermission({{$result['group_id']}},{{count($result['permissions'])}})"
                                                name="checkPermission" type="checkbox" value="{{$permission['name']}}" {{$permission['is_checked']}}
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="updateData({{ $role->id }})" class="btn btn-success">Save</button>
            </div>
        </div>
    </div>
</div>
